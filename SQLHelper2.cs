...
namespace Base
{
    ...
    public sealed class SqlHelper2
    {
        ...
        public static string sConStr = "ConStr1";
        ...
        /// <returns></returns>
        public static bool f_bTransactionQuery(System.Collections.Generic.List<string> listSQL, SqlParameter[] para)
        {
            SqlConnection con = GetConnection();    //获取数据库连接
            con.Open(); //打开连接
        ...
        /// <param name="listSQL"></param>
        /// <returns></returns>
        public static bool f_bTransactionQuery(
            System.Collections.Generic.List<string> listSQL
            ,System.Collections.Generic.List<System.Collections.Generic.List<SqlParameter>> paraListList
            )
        {
            Dal_SOLHelper.st_GblVariableHelper.TimeMax = listSQL.Count;
            ...
            try
            {
                ...
                {
                    Dal_SOLHelper.st_GblVariableHelper.TimeLoadingI = i;

                    cmd.CommandText = listSQL[i];
                    cmd.Parameters.AddRange(paraListList[i].ToArray());
                    cmd.ExecuteNonQuery();
        ...
        /// <summary>
        /// 用事务完成多项数据库新增，并返回最新的数据集
        /// </summary>
        /// <param name="listSQL"></param>
        /// <returns></returns>
        public static DataSet fDS_TransactionQuery(
            string SQLMaxID
            ,System.Collections.Generic.List<string> listSQL
            , System.Collections.Generic.List<System.Collections.Generic.List<SqlParameter>> paraListList
            ,string SQLResult
            )
        {
            ...
            try
            {
                ...
                object MaxIDI =  cmd.ExecuteScalar();
                ...
                for (int i = 0; i < listSQL.Count; i++)
                {
                    ...
                    cmd.CommandText = listSQL[i];
                    //cmd.Parameters.Add("@MaxID", SqlDbType.Int, int.Parse(MaxIDI.ToString()));
                    SqlParameter para = new SqlParameter("@MaxID", SqlDbType.Int);
                    para.Value = MaxIDI;
                    paraListList[i].Add(para);
                    SqlParameter[] paraARR=paraListList[i].ToArray();
                ...
                //返加结果集
                cmd.CommandText = SQLResult;
                SqlParameter paraResult = new SqlParameter("@MaxID", SqlDbType.Int);
                paraResult.Value = MaxIDI;
        ...
        /// <param name="listSQL"></param>
        /// <returns></returns>
        public static  bool f_bTransactionUpdate(System.Collections.Generic.List<string> listSQL)
        {
            SqlConnection con = GetConnection();//获取数据库连接
            con.Open();//打开连接
            SqlTransaction sqltra = con.BeginTransaction();//开始事务
        ...
        {
            return ConfigurationManager.ConnectionStrings[sConStr].ConnectionString;
        }
        /// <summary> 
        /// 一个有效的数据库连接对象 
        /// </summary> 
        ...
        public static int ExecuteNonQuery(string connectionString, string spName, params object[] parameterValues)
        {
            ...
            if ((parameterValues != null) && (parameterValues.Length > 0))
            {
                ...
                SqlParameter[] commandParameters = SqlHelper2ParameterCache2.GetSpParameterSet(connectionString, spName);
        ...
        public static int ExecuteNonQuery(SqlConnection connection, string spName, params object[] parameterValues)
        {
            ...
            {
                // 从缓存中加载存储过程参数 
                SqlParameter[] commandParameters = SqlHelper2ParameterCache2.GetSpParameterSet(connection, spName);
        ...
        public static int ExecuteNonQuery(SqlTransaction transaction, string spName, params object[] parameterValues)
        {
            ...
            if ((parameterValues != null) && (parameterValues.Length > 0))
            {
                ...
                SqlParameter[] commandParameters = SqlHelper2ParameterCache2.GetSpParameterSet(transaction.Connection, spName);
    ...
    /// <summary> 
    /// SqlHelper2ParameterCache2提供缓存存储过程参数,并能够在运行时从存储过程中探索参数. 
    /// </summary> 
    public sealed class SqlHelper2ParameterCache2
    {
        #region 私有方法,字段,构造函数
        // 私有构造函数,妨止类被实例化. 
        private SqlHelper2ParameterCache2() { }
